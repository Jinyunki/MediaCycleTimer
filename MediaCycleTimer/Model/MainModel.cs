...
namespace MediaCycleTimer.Model {
    public class MainModel : ViewModelBase {
        ...
        private ViewCapture _viewCaptureInstance = ViewCapture.Instance;
        public ViewCapture ViewCaptureInstance {
            get { return _viewCaptureInstance; }
            set {
                if (_viewCaptureInstance != value) {
                    _viewCaptureInstance = value;
                    RaisePropertyChanged("ViewCaptureInstance");
                }
            }
        }
